    ...
    <div className="wrapper clear">
        ...
        <div className="cart d-flex flex-column p-30">
          ...
          <div className="cart-items d-flex flex-column">
            <div className="cart-item d-flex align-center mb-20">
              <img width={70} height={70} src="/img/sneakers/sneakers-1.png" alt="Sneakers" className="cart-item__img" />
              <div className="cart-item__desc d-flex flex-column">
                <p className="cart-item__name mb-10">Мужские Кроссовки Nike Air Max 270</p>
      ...
      <header className="header d-flex justify-between align-center p-40">
        ...
        <ul className="header-right d-flex ">
          <li className="header-right__item mr-30">
      ...
      <div className="content p-40">
        ...
        <div className="sneakers">
          <div className="product-card">
            <img width={133} height={122} src="/img/sneakers/sneakers-1.png" alt="Sneakers" className="product-card__img" />
            <h5 className="product-card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="product-card-price d-flex justify-between">
              <div className="product-card-price__wrap d-flex flex-column">
                ...
                <span className="product-card-price__amont">12 999р.</span>
              </div>
              <button className="product-card__tocart d-flex justify-center align-center">
                <img width={11} height={11} src="/img/plus.svg" alt="" className="product-card__tocart-img" />
              </button>
            </div>
          </div>
          <div className="product-card">
            <img width={133} height={122} src="/img/sneakers/sneakers-2.png" alt="Sneakers" className="product-card__img" />
            <h5 className="product-card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="product-card-price d-flex justify-between">
              <div className="product-card-price__wrap d-flex flex-column">
                <span className="product-card-price__desc">Цена:</span>
          ...
          <div className="product-card">
            <img width={133} height={122} src="/img/sneakers/sneakers-3.png" alt="Sneakers" className="product-card__img" />
            <h5 className="product-card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="product-card-price d-flex justify-between">
              <div className="product-card-price__wrap d-flex flex-column">
                <span className="product-card-price__desc">Цена:</span>
          ...
          <div className="product-card">
            <img width={133} height={122} src="/img/sneakers/sneakers-4.png" alt="Sneakers" className="product-card__img" />
            <h5 className="product-card__title">Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="product-card-price d-flex justify-between">
              <div className="product-card-price__wrap d-flex flex-column">
                <span className="product-card-price__desc">Цена:</span>
